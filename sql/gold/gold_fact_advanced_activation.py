...
CREATE OR REPLACE TABLE gold_fact_advanced_activation AS
...
core_events AS (
    ...
    FROM gold_fact_product_events e
...
SELECT
    ...
    COALESCE(e.CoreEventsInFirst14Days, 0)
        AS CoreEventsInFirst14Days,

    COALESCE(d.DealsInFirst14Days, 0)
...
print("✅ Created gold_fact_advanced_activation")
